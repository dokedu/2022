...
type EntryAccount = Database['public']['Tables']['entry_accounts']['Row']
type EntryAccountCompetence = Database['public']['Tables']['entry_account_competences']['Row']
type EntryEvent = Database['public']['Tables']['entry_events']['Row']
type EntryFile = Database['public']['Tables']['entry_files']['Row']
type EntryTag = Database['public']['Tables']['entry_tags']['Row']
