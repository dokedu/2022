      ...
      <div class="rounded-lg bg-white py-8 px-4 shadow sm:px-10">
        <form v-if="!success" class="space-y-6" @submit.prevent="login">
          <div>
            ...
            <h2 class="text-md mb-2 font-semibold text-gray-900">Passwort zurücksetzen</h2>
        ...
        <div v-else>
          <h2 class="mb-2 text-xl font-medium text-gray-900">Bitte überprüfen deine Emails</h2>
